...
def build_result_bundle(*, run_id:str|None, model_id:str, tool_ref:str,
                        result:Any, schema_version:str="1.0-M", input_refs:list[str]|None=None)->dict[str,Any]:
    ...
    return {
        ...
        "warnings":[],"provenance":{"input_refs":list(input_refs or []),"code_ref":tool_ref,"environment":"target-venv"}
    }
