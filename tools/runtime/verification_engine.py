"""V0.9-H verification bridge with registry and mathematical acceptance."""
...
def verify_executions(project_dir: str | Path, executions: list[dict], dispatch: dict) -> list[dict]:
    ...
    summary.write_text(json.dumps({"artifact_type":"VerificationSummary","schema_version":"0.9","acceptance_version":"0.9-H","rule_registry":registry.manifest(),"reports":reports}, ensure_ascii=False, indent=2), encoding="utf-8")
    return reports
